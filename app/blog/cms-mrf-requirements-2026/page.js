      ...
      <section>
        <div className="container" style={{ maxWidth: 820 }}>
          <p style={{ fontSize: 17, color: "var(--muted)", marginBottom: 24 }}>
            Under 45 CFR §180.50, every US hospital must publish a machine-readable file (MRF) listing prices for all items and services. Since enforcement began CMS has issued 730+ CMS warning notices and civil monetary penalties against 28 hospitals — and CMS has scaled its automated compliance reviews from 30–40 to over 200 per month. Here&apos;s exactly what the file must contain.
          </p>
