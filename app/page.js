        ...
        <div className="container">
          ...
          <p className="sub">
            Every US hospital must publish payer-specific negotiated rates in a machine-readable file.
              CMS has issued 730+ CMS warning notices and 28 civil monetary penalties since enforcement began — and has grown its automated compliance reviews from 30–40 to over 200 per month. At the statutory maximum ($5,500/day for hospitals over 550 beds), one flagged month runs to $165,000.
          </p>
